        ...
        <div className="grow p-16 px-44">
            <div className="w-full flex justify-around">
                <div className="w-1/3 flex flex-col gap-5">
                    ...
                    {friends.map((name, i) =>
                        <div key={i} className="border-3 border-sky-800 rounded-lg text-2xl p-5">{name}</div>
                    )}
                </div>
                <div className="w-1/3 flex flex-col gap-5">
                    <div className="text-4xl mb-6 tracking-tight flex justify-between">
                    ...
                    {friendRequests.map((name, i) =>
                        <div key={i} className="flex justify-between items-center border-3 border-amber-400 rounded-lg p-5">
